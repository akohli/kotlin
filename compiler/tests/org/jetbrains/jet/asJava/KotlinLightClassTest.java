...
public abstract class KotlinLightClassTest extends KotlinAsJavaTestBase {
    ...
    public static class ClassWithNoTypeField extends KotlinLightClassTest {
        @Override
        protected List<File> getKotlinSourceRoots() {
            return Collections.singletonList(
                    new File("compiler/testData/asJava/lightClasses/ClassWithNoTypeField.kt")
            );
        }

        public void testClassWithNoTypeField() {
            checkModifiers("test.Test", PUBLIC, FINAL);
        }
    }
