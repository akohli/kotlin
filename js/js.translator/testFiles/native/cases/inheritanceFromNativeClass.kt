...
fun box(): String {
    ...
    if (a.foo(4) != "B.foo(4: Int)") return "b.foo(4) != \"B.foo(4: Int)\", it: ${a.foo(4)}"
    if (a.boo(434) != "A.boo(434)") return "b.boo(434) != \"A.boo(434)\", it: ${a.boo(434)}"
    if (a.baz(34) != "B.baz(34: Int)") return "b.baz(34) != \"B.baz(34: Int)\", it: ${a.baz(34)}"
